...
| 13 | MG92B予備2個の配分方針決定（R系予備 or S系ベンチ軸） | 中 | 在庫5個（3軸分＋予備2個）。R系3軸＋S系ベンチ2軸で必要数は計5軸のため、数量上は予備2個で足りる。案(a)R系予備2個をS系へ充当（R系は予備なしとなる）／案(b)S系用に別途2個調達しR系予備を維持、のいずれかが未確定 | 案(a)(b)いずれかを選択し、実装前に確定する | 未定 | `docs/R/reserved_axes.md`、`docs/S/bench_axes_S3S4.md` |
