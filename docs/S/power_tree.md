...
- [ ] **10kΩ NTCサーミスタ ×1**（基板温度センサー。`docs/S/mcu_pinmap.md` A3）
- [ ] **RXEF250 ×2以上（予備込み4本を推奨）**（紛失により在庫ゼロ。`docs/OPEN_ISSUES.md` #41）
- [ ] **HS-805BB ×2**（首回転・首上下。`docs/L/print_record_L.md` §3の実測により確定）
- [ ] **JX PDI-6221MG ×1**（顎。公式i2Head指定。`docs/OPEN_ISSUES.md` #11）
