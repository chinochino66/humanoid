...
|---|---|---|---|---|
| MG92B | 5個 | 3軸（upperLip／cheekRight／cheekLeft） | 3軸分＋予備2個。**部品表では「高荷重5軸（上唇・頬×2・喉ゲート・味覚リフト）→MG92B×5」として案(a)（予備2個をS系ベンチ軸throatGate／tasteSensorLiftへ充当し、R系は予備なしとする）を前提としているが、正式採否は未確認。**`docs/S/bench_axes_S3S4.md` §1・`docs/OPEN_ISSUES.md` #13参照 | **2027年R系向け在庫。2026年に実装しない（予備2個を除く）** |
...
- [ ] **MG92B予備2個の配分方針の正式採否確認。**部品表では案a（S系ベンチ軸throatGate／tasteSensorLiftへ充当し、R系は予備なしとする）を前提としている。案b（S系用に別途2個調達し、R系の予備2個を維持する）は部品表に未反映。`docs/S/bench_axes_S3S4.md` §1、`docs/OPEN_ISSUES.md` #13参照
